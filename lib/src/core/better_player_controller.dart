...
class BetterPlayerController {
  BetterPlayerController(
    ...
    _betterPlayerControlsConfiguration = BetterPlayerControlsConfiguration(
      controlBarColor: betterPlayerConfiguration.controlsConfiguration.controlBarColor,
      textColor: betterPlayerConfiguration.controlsConfiguration.textColor,
      iconsColor: betterPlayerConfiguration.controlsConfiguration.iconsColor,
      playIcon: betterPlayerConfiguration.controlsConfiguration.playIcon,
      pauseIcon: betterPlayerConfiguration.controlsConfiguration.pauseIcon,
      muteIcon: betterPlayerConfiguration.controlsConfiguration.muteIcon,
      unMuteIcon: betterPlayerConfiguration.controlsConfiguration.unMuteIcon,
      fullscreenEnableIcon: betterPlayerConfiguration.controlsConfiguration.fullscreenEnableIcon,
      fullscreenDisableIcon: betterPlayerConfiguration.controlsConfiguration.fullscreenDisableIcon,
      skipBackIcon: betterPlayerConfiguration.controlsConfiguration.skipBackIcon,
      skipForwardIcon: betterPlayerConfiguration.controlsConfiguration.skipForwardIcon,
      nextIcon: betterPlayerConfiguration.controlsConfiguration.nextIcon,
      previousIcon: betterPlayerConfiguration.controlsConfiguration.previousIcon,
      enableFullscreen: betterPlayerConfiguration.controlsConfiguration.enableFullscreen,
      enableMute: betterPlayerConfiguration.controlsConfiguration.enableMute,
      enableProgressText: betterPlayerConfiguration.controlsConfiguration.enableProgressText,
      enableProgressBar: betterPlayerConfiguration.controlsConfiguration.enableProgressBar,
      enableProgressBarDrag: betterPlayerConfiguration.controlsConfiguration.enableProgressBarDrag,
      enablePlayPause: betterPlayerConfiguration.controlsConfiguration.enablePlayPause,
      enableSkips: betterPlayerConfiguration.controlsConfiguration.enableSkips,
      enableNext: betterPlayerConfiguration.controlsConfiguration.enableNext,
      enablePrevious: betterPlayerConfiguration.controlsConfiguration.enablePrevious,
      goNext: betterPlayerConfiguration.goNext ?? betterPlayerConfiguration.controlsConfiguration.goNext,
      goPrevious: betterPlayerConfiguration.goPrevious ?? betterPlayerConfiguration.controlsConfiguration.goPrevious,
      checkCanGoNext:
          betterPlayerConfiguration.checkCanGoNext ?? betterPlayerConfiguration.controlsConfiguration.checkCanGoNext,
      checkCanGoPrevious:
          betterPlayerConfiguration.checkCanGoPrevious ??
          betterPlayerConfiguration.controlsConfiguration.checkCanGoPrevious,
      enableAudioTracks: betterPlayerConfiguration.controlsConfiguration.enableAudioTracks,
      progressBarPlayedColor: betterPlayerConfiguration.controlsConfiguration.progressBarPlayedColor,
      progressBarHandleColor: betterPlayerConfiguration.controlsConfiguration.progressBarHandleColor,
      progressBarBufferedColor: betterPlayerConfiguration.controlsConfiguration.progressBarBufferedColor,
      progressBarBackgroundColor: betterPlayerConfiguration.controlsConfiguration.progressBarBackgroundColor,
      controlsHideTime: betterPlayerConfiguration.controlsConfiguration.controlsHideTime,
      customControlsBuilder: betterPlayerConfiguration.controlsConfiguration.customControlsBuilder,
      playerTheme: betterPlayerConfiguration.controlsConfiguration.playerTheme,
      showControls: betterPlayerConfiguration.controlsConfiguration.showControls,
      showControlsOnInitialize: betterPlayerConfiguration.controlsConfiguration.showControlsOnInitialize,
      controlBarHeight: betterPlayerConfiguration.controlsConfiguration.controlBarHeight,
      liveTextColor: betterPlayerConfiguration.controlsConfiguration.liveTextColor,
      enableOverflowMenu: betterPlayerConfiguration.controlsConfiguration.enableOverflowMenu,
      enablePlaybackSpeed: betterPlayerConfiguration.controlsConfiguration.enablePlaybackSpeed,
      enableSubtitles: betterPlayerConfiguration.controlsConfiguration.enableSubtitles,
      ...
      playbackSpeedIcon: betterPlayerConfiguration.controlsConfiguration.playbackSpeedIcon,
      qualitiesIcon: betterPlayerConfiguration.controlsConfiguration.qualitiesIcon,
      subtitlesIcon: betterPlayerConfiguration.controlsConfiguration.subtitlesIcon,
      audioTracksIcon: betterPlayerConfiguration.controlsConfiguration.audioTracksIcon,
      overflowMenuIconsColor: betterPlayerConfiguration.controlsConfiguration.overflowMenuIconsColor,
      forwardSkipTimeInMilliseconds: betterPlayerConfiguration.controlsConfiguration.forwardSkipTimeInMilliseconds,
      backwardSkipTimeInMilliseconds: betterPlayerConfiguration.controlsConfiguration.backwardSkipTimeInMilliseconds,
      loadingColor: betterPlayerConfiguration.controlsConfiguration.loadingColor,
      loadingWidget: betterPlayerConfiguration.controlsConfiguration.loadingWidget,
  ...
  void toggleFullScreen() {
    if (betterPlayerConfiguration.onFullScreen != null) {
      if (!betterPlayerConfiguration.onFullScreen!(!_isFullScreen)) {
        return;
      }
    }
